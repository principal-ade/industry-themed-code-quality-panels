...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Debug panel for inspecting raw lens data from quality-lens-cli. Shows files analyzed, issues by file, and metrics for each lens result.'
      }
    }
  },
  tags: ['autodocs'],
...
export const RealData: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real data from codebase-quality-lens-cli GitHub Actions artifact. Click on a lens to expand and see files with issues.'
      }
    }
  }
};
...
export const WithFileClick: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'With file click handler - clicking a file or issue will trigger navigation callback.'
      }
    }
  }
};
...
const mixedData: FormattedResults = {
  ...
  results: [
    ...
    },
    {
      ...
      fileMetrics: [
        { file: 'src/index.ts', score: 95, issueCount: 0, errorCount: 0, warningCount: 0 },
        { file: 'src/utils.ts', score: 88, issueCount: 0, errorCount: 0, warningCount: 0 },
      ],
    },
    {
      package: { name: '@example/core', path: 'packages/core' },
...
const monorepoData: FormattedResults = {
  ...
  results: [
    ...
    // @acme/web package
    {
      ...
      issues: [
        { file: 'src/pages/Home.tsx', line: 15, severity: 'error', message: "Property 'data' is missing", rule: 'TS2741', source: 'typescript' },
        { file: 'src/pages/Home.tsx', line: 28, severity: 'error', message: "Type 'undefined' is not assignable", rule: 'TS2322', source: 'typescript' },
      ],
    ...
    },
    {
      ...
      issues: [
        ...
        { file: 'src/utils/helpers.ts', line: 12, severity: 'warning', message: "Unexpected any. Specify a different type.", rule: '@typescript-eslint/no-explicit-any', source: 'eslint' },
      ...
      metrics: { filesAnalyzed: 45, totalIssues: 3, issuesBySeverity: { error: 1, warning: 2, info: 0, hint: 0 }, executionTime: 1500 },
    },
    {
      package: { name: '@acme/web', path: 'apps/web' },
      lens: { id: 'jest', command: 'test' },
...
export const MixedResults: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Mixed results with typescript errors, passing tests with coverage, and formatting issues.'
      }
    }
  }
};
...
export const Monorepo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multi-package monorepo with 3 packages. Click package buttons to switch between them. @acme/core is clean, @acme/web has issues, @acme/cli is clean.'
      }
    }
  }
};
...
export const MonorepoPreselected: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Monorepo with @acme/web pre-selected (the package with issues).'
      }
    }
  }
};
