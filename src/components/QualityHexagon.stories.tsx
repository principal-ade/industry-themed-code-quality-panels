...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A hexagonal radar chart visualization for code quality metrics. Each vertex represents a different quality dimension, creating a unique "fingerprint" for code quality.'
      }
    }
  },
  tags: ['autodocs'],
...
export const Unbalanced: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Shows a codebase with excellent documentation and code style, but poor test coverage.'
      }
    }
  }
};
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ width: 96, height: 96 }}>
          <QualityHexagon metrics={goodMetrics} tier="gold" theme={slateTheme} />
        </div>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ marginTop: 8, fontSize: 14, color: '#9ca3af' }}>Extra Large</p>
      </div>
    </div>
  )
};
...
export const Compact: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
      <QualityHexagonCompact metrics={excellentMetrics} tier="platinum" theme={slateTheme} />
      <QualityHexagonCompact metrics={goodMetrics} tier="gold" theme={slateTheme} />
      <QualityHexagonCompact metrics={averageMetrics} tier="silver" theme={slateTheme} />
      <QualityHexagonCompact metrics={poorMetrics} tier="bronze" theme={slateTheme} />
    </div>
  ),
  parameters: {
    docs: {
...
export const Detailed: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, width: 600 }}>
      <QualityHexagonDetailed metrics={excellentMetrics} tier="platinum" theme={slateTheme} />
      <QualityHexagonDetailed metrics={unbalancedMetrics} tier="gold" theme={slateTheme} />
    </div>
  ),
  parameters: {
    ...
    docs: {
      description: {
        story: 'Detailed view with full metrics breakdown, ideal for dashboards and reports.'
      }
    }
  }
};
  ...
  render: () => (
    <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ marginTop: 16, fontSize: 14, fontWeight: 600, color: '#e5e7eb' }}>Before Refactoring</p>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ marginTop: 16, fontSize: 14, fontWeight: 600, color: '#e5e7eb' }}>After Refactoring</p>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ width: 144, height: 144, margin: '0 auto' }}>
          <QualityHexagon metrics={excellentMetrics} tier="platinum" theme={slateTheme} />
        </div>
        <p style={{ marginTop: 8, fontWeight: 600, color: '#e5e7eb' }}>Backend Team</p>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ marginTop: 8, fontWeight: 600, color: '#e5e7eb' }}>Frontend Team</p>
        <p style={{ fontSize: 12, color: '#9ca3af' }}>Web Application</p>
      </div>
      <div style={{ textAlign: 'center' }}>
        <div style={{ width: 144, height: 144, margin: '0 auto' }}>
          <QualityHexagon metrics={averageMetrics} tier="silver" theme={slateTheme} />
        </div>
        <p style={{ marginTop: 8, fontWeight: 600, color: '#e5e7eb' }}>Mobile Team</p>
      ...
      {(['none', 'bronze', 'silver', 'gold', 'platinum'] as const).map((tier) => (
        <div key={tier} style={{ textAlign: 'center' }}>
          <div style={{ width: 120, height: 120 }}>
            <QualityHexagon
              metrics={
                tier === 'platinum' ? excellentMetrics :
                tier === 'gold' ? goodMetrics :
                tier === 'silver' ? averageMetrics :
                tier === 'bronze' ? poorMetrics :
                { tests: 10, deadCode: 80, linting: 15, formatting: 20, types: 5, documentation: 10 }
              }
              tier={tier}
              theme={slateTheme}
            />
