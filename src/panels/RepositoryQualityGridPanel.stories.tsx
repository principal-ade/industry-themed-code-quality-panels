...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A panel that displays quality metrics for multiple repositories in a flat grid layout. Includes metric filtering dropdown, sorting by value, and click interactions.',
      },
    },
  },
  tags: ['autodocs'],
...
export const InContainer: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Panel rendered in a fixed-size container, simulating a panel slot in the application.',
      },
    },
  },
};
